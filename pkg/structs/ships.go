	...
	return []parser.ContainerItem{
		...
		Section("#Ship Classes",
			Multi(Section("$Name",
				...
				StringValue("$Warpin type"),
				StringValue("$Warpout type"),
				...
				StringValue("$Allowed PBanks"),
				StringValue("$Allowed Dogfight PBanks"),
				StringListValue("$Default PBanks"),
				StringListValue("$PBank Capacity"),
				BooleanListValue("$Show Primary Models"),
				StringValue("$Allowed SBanks"),
				StringValue("$Allowed Dogfight SBanks"),
				...
				FloatValue("$Shield Regneration Rate"),
				...
				Multi(Section("$Subsystem",
					...
					StringValue("$Armor Type"),
					IntegerListValue("$Default PBanks", 3),
					IntegerListValue("$PBank Capacity", 4),
					IntegerListValue("$Default SBanks", 3),
